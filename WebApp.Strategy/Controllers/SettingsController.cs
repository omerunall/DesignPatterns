...
namespace WebApp.Strategy.Controllers
{
    public class SettingsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if (User.Claims.Where(w => w.Type == Settings.claimDatabaseType).FirstOrDefault() != null)
        ...
        public async Task<IActionResult> ChangeDatabase(int databaseType)
        {
            ...
            var newClasim = new Claim(Settings.claimDatabaseType, databaseType.ToString());
            ...
            {
                await _userManager.ReplaceClaimAsync(user, hasDatabaseTypeClaim, newClasim);
            }
            else
            {
                await _userManager.AddClaimAsync(user, newClasim);
            }
